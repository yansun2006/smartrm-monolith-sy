...
import com.sy.smartrm.smartrmmonolith.commodity.adapter.convertor.plaintext.CurrencyPropertyTextParser;
import com.sy.smartrm.smartrmmonolith.commodity.adapter.convertor.plaintext.DatePropertyTextParser;
import com.sy.smartrm.smartrmmonolith.commodity.adapter.convertor.plaintext.DateTimePropertyTextParser;
import com.sy.smartrm.smartrmmonolith.commodity.adapter.convertor.plaintext.FloatPropertyTextParser;
import com.sy.smartrm.smartrmmonolith.commodity.adapter.convertor.plaintext.ImageUrlPropertyTextParser;
import com.sy.smartrm.smartrmmonolith.commodity.adapter.convertor.plaintext.IntegerPropertyTextParser;
import com.sy.smartrm.smartrmmonolith.commodity.adapter.convertor.plaintext.MapPropertyTextParser;
import com.sy.smartrm.smartrmmonolith.commodity.adapter.convertor.plaintext.StringPropertyTextParser;
